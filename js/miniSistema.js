...
let jordy = new empleado("Jordy", 29, "3543654gdfslkj", 13, 28, 156.78);

jordy.imprimirInfo();
jordy.sueldoMensualBruto();
jordy.sueldoMensualNeto();
jordy.sueldoQuincenalBruto();
jordy.sueldoQuincenalNeto();